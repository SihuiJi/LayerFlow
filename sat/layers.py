...
from sat.mpu.mappings import gather_from_model_parallel_region
from sat.mpu.mappings import reduce_from_model_parallel_region
from sat.mpu.mappings import scatter_to_model_parallel_region
from sat.mpu.utils import divide, unscaled_init_method
from sat.mpu.utils import VocabUtility
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_, scale=1):
