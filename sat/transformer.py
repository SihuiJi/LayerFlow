...
from sat import mpu
from sat.mpu import get_model_parallel_world_size, VocabParallelEmbedding, gather_from_model_parallel_region, copy_to_model_parallel_region, checkpoint
...
class BaseTransformer(torch.nn.Module):
    ...
    def forward(self, input_ids, position_ids, attention_mask, *,
        ...
        if position_embeddings is not None:
            ...
            # hidden_states torch.Size([3, 7878, 1920])
            # print('position_embeddings',position_embeddings.shape)
            # position_embeddings torch.Size([1, 7878, 1920])
